...
const OrderForm = () => {
    ...
    const generateSetterFunction = (setter: any) => (e: any) => setter(e.target.value);
            ...
            <div className='w-full flex flex-col gap-5'>
                <div className="flex pt-5 justify-between">
                    <div className="w-[65%] px-4 py-3 pb-10 bg-[#FAFBFF] rounded-[12px]">
                        ...
                        <div className='flex flex-col gap-5 items-center'>
                            <div className="flex w-full justify-between items-start gap-[18px] relative flex-[0_0_auto]">
                                <div className='w-[10%]'>
                                    {renderInputField(ADD_ORDER_INPUTS[0], startDate, (e) => setStartDate(e.target.value), undefined, undefined, "w-full")}
                                </div>
                                {renderInputField(ADD_ORDER_INPUTS[1], serviceType, (e) => setServiceType(e.target.value), undefined, undefined, "w-[50%]")}
                                {renderInputField(ADD_ORDER_INPUTS[2], vehicle, (e) => setVehicle(e.target.value), undefined, undefined, "w-[30%]")}
                            </div>
                            <div className="flex w-full justify-between items-start gap-[18px] relative flex-[0_0_auto]">
                                <div className='w-[50%] flex justify-start gap-14'>
                                    {renderInputField(ADD_ORDER_INPUTS[3], endDate, (e) => setEndDate(e.target.value), undefined, undefined, "w-[20%]")}
                                    {renderInputField(ADD_ORDER_INPUTS[4], weight, (e) => setWeight(e.target.value), undefined, undefined, "w-[20%]")}
                                    {renderInputField(ADD_ORDER_INPUTS[5], volume, (e) => setVolume(e.target.value), undefined, undefined, "w-[20%]")}
                                </div>
                                {renderInputField(ADD_ORDER_INPUTS[6], price, (e) => setPrice(e.target.value), undefined, undefined, "w-[30%]")}
                            </div>
                            <div className="flex w-full justify-between items-start gap-[12px] relative flex-[0_0_auto]">
                                {renderInputField(ADD_ORDER_INPUTS[7], status, (e) => setStatus(e.target.value))}
                                <div className='w-[45%]'>
                    ...
                    <div className="flex flex-col w-[34%] gap-5 px-4 py-3 pb-10 bg-[#FAFBFF] rounded-[12px]">
                        ...
                        {renderInputField(ADD_ORDER_INPUTS[9], client, (e) => setClient(e.target.value), undefined, undefined, "w-[40%]")}
                        <div className="flex w-full justify-start items-start gap-5 relative flex-[0_0_auto]">
                            {renderInputField(ADD_ORDER_INPUTS[10], countryCode, (e) => setCountryCode(e.target.value), undefined, undefined, "w-[20%]")}
                            {renderInputField(ADD_ORDER_INPUTS[11], phone, (e) => setPhone(e.target.value), undefined, undefined, "w-[40%]")}
                        </div>
                        {renderInputField(ADD_ORDER_INPUTS[12], email, (e) => setEmail(e.target.value), undefined, undefined, "w-[65%]")}
                    </div>
                </div>
                {/* Addresse de depart */}
                <div className="flex flex-col w-full gap-5 px-4 py-3 pb-10 bg-[#FAFBFF] rounded-[12px]">
                    ...
                    <div className='flex flex-col gap-5 items-center'>
                        {renderInputField(ADD_ORDER_INPUTS[13], clientAddress, (e) => setClientAddress(e.target.value), undefined, undefined, "w-full")}
                        {renderInputField(ADD_ORDER_INPUTS[14], searchKeyword1, (e) => setSearchKeyword1(e.target.value), undefined, undefined, "w-full")}
                        ...
                        <div className="flex w-full justify-between items-start gap-5 relative flex-[0_0_auto]">
                            {renderInputField(ADD_ORDER_INPUTS[15], lat1, (e) => setLat1(e.target.value), undefined, undefined, "w-[45%]")}
                            {renderInputField(ADD_ORDER_INPUTS[16], lon1, (e) => setLon1(e.target.value), undefined, undefined, "w-[45%]")}
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col w-full gap-5 px-4 py-3 pb-10 bg-[#FAFBFF] rounded-[12px]">
                    ...
                    <div className='flex flex-col gap-5 items-center'>
                        {renderInputField(ADD_ORDER_INPUTS[17], searchKeyword2, (e) => setSearchKeyword2(e.target.value), undefined, undefined, "w-full")}
                        {renderInputField(ADD_ORDER_INPUTS[18], lat2, (e) => setLat2(e.target.value), undefined, undefined, "w-full")}
                        <div className='w-full h-72 rounded-lg bg-slate-400'
                            style={{
                                backgroundImage: `url(${backgroundImage})`,
                                backgroundSize: "cover",
                        ...
                        <div className="flex w-full justify-between items-start gap-5 relative flex-[0_0_auto]">
                            {renderInputField(ADD_ORDER_INPUTS[19], lon2, (e) => setLon2(e.target.value), undefined, undefined, "w-[45%]")}
                            {renderInputField(ADD_ORDER_INPUTS[20], price, (e) => setPrice(e.target.value), undefined, undefined, "w-[45%]")}
                        </div>
                    </div>
                </div>
            </div>
